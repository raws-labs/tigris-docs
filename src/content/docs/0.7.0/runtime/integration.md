...
sidebar:
  order: 410
slug: 0.7.0/runtime/integration
---
...
**Loader errors** (`tigris_error_t`): See [API Reference](/runtime/api-reference/) for the full error enum.

**Memory errors** (`tigris_mem_error_t`): See [API Reference](/runtime/api-reference/) for the full error enum.

**Executor errors** (`tigris_exec_error_t`): See [API Reference](/runtime/api-reference/) for the full error enum.

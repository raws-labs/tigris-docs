...
[`tigris inspect`](/toolchain/inspect/) reports for the plan. A `.bin` file holds
...
A [zoo](/toolchain/zoo/) download ships an example input and the matching
reference output:
...
[the tutorials](/tutorials/esp-idf-deployment/) for that.

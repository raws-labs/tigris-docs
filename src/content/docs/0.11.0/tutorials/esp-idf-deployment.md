...
sidebar:
  order: 200
slug: 0.11.0/tutorials/esp-idf-deployment
---
...
[`compile`](/0.11.0/toolchain/compile/) reference and the
[Quickstart](/0.11.0/getting-started/quickstart/) for more on budgets and XIP.
...
- [`compile`](/0.11.0/toolchain/compile/): the full CLI reference.
- The [Cortex-M deployment guide](/0.11.0/tutorials/cortex-m-deployment/): the same idea
  on Arm Cortex-M, with the plan embedded in the firmware.
- [Operator and Backend Support](/0.11.0/runtime/operator-support/): what the ESP-NN
  backend accelerates.

...
sidebar:
  order: 100
slug: 0.11.0/tutorials/cortex-m-deployment
---
...
budget until the plan fits. See the [`compile`](/0.11.0/toolchain/compile/)
reference for the full flag set and [Operator and Backend
Support](/0.11.0/runtime/operator-support/) for what the
...
[`codegen`](/0.11.0/toolchain/codegen/) for the other formats
and backends.
...
- [`compile`](/0.11.0/toolchain/compile/) and
  [`codegen`](/0.11.0/toolchain/codegen/): the full CLI
  reference.

---
title: "Integration"
description: "A step-by-step guide to integrating the TiGrIS C99 runtime into your embedded application."
sidebar:
  order: 410
slug: 0.11.0/runtime/integration
---
...
[ESP-IDF tutorial](/0.11.0/tutorials/esp-idf-deployment/) walks a working project.
...
**Loader errors** (`tigris_error_t`): See [API Reference](/0.11.0/runtime/api-reference/) for the full error enum.

**Memory errors** (`tigris_mem_error_t`): See [API Reference](/0.11.0/runtime/api-reference/) for the full error enum.

**Executor errors** (`tigris_exec_error_t`): See [API Reference](/0.11.0/runtime/api-reference/) for the full error enum.

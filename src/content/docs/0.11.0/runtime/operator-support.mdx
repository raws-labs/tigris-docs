...
description: "Choose between portable C, ESP-NN, and CMSIS-NN, and see where TiGrIS uses native acceleration or a safe fallback."
sidebar:
  order: 410
slug: 0.11.0/runtime/operator-support
---

...
sidebar:
  order: 430
slug: 0.11.0/runtime/host-library
---
...
[`tigris run`](/0.11.0/toolchain/run/) and `tigris.runtime.Session` call, and it is
...
[Using your own host library](/0.11.0/toolchain/run/#using-your-own-host-library).
...
[`tigris inspect`](/0.11.0/toolchain/inspect/) prints. Dtypes use the ONNX codes: 1 is

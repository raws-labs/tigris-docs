...
description: "Produce an ONNX model TiGrIS compiles to an int8 plan, the two quantizer settings that decide whether it works, and how to check the result."
sidebar:
  order: 160
slug: 0.11.0/guides/quantizing-to-int8
---

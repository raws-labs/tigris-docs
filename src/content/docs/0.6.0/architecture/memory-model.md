---
title: Memory Model
description: TiGrIS's three-region memory model — a compile-time execution
  schedule over caller-provided arenas allocated and compacted by the runtime.
sidebar:
  order: 330
slug: 0.6.0/architecture/memory-model
---

---
title: Tiling
description: Tiling is how TiGrIS fits large models into small SRAM — processing
  feature maps in horizontal strips cuts peak activation memory in proportion to
  strip height.
sidebar:
  order: 320
slug: 0.6.0/architecture/tiling
---

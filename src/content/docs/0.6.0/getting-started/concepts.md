---
title: Core Concepts
description: The key ideas behind how TiGrIS compiles and executes ML models on
  memory-constrained embedded devices.
sidebar:
  order: 130
slug: 0.6.0/getting-started/concepts
---
...
For implementation details and formulas, see [Tiling](/0.6.0/architecture/tiling/).

...
description: Use tigris codegen to generate backend-specific C source from a
  compiled .tgrs plan, wiring up runtime memory and kernel dispatch.
sidebar:
  order: 230
slug: 0.6.0/toolchain/codegen
---
...
See [Operator and Backend Support](/0.6.0/runtime/operator-support/)

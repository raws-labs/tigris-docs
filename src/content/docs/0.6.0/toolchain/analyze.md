...
description: Use tigris analyze to check whether an ONNX model fits your
  target's memory constraints before you compile it.
sidebar:
  order: 210
slug: 0.6.0/toolchain/analyze
---
...
* **needs\_work**: some stages cannot be tiled and exceed the budget

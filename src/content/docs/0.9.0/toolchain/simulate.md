...
Size arguments accept plain bytes (`262144`), kilobytes (`256K`), megabytes (`4M`), or fractional values (`2.5M`). See [tigris analyze](/0.9.0/toolchain/analyze/) for the full size syntax table.

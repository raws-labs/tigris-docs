...
sidebar:
  order: 105
slug: 0.9.0/getting-started/quickstart
---
...
[Operator and Backend Support](/0.9.0/runtime/operator-support/).
...
[Runtime Integration](/0.9.0/runtime/integration/).

## What's next

* [Core Concepts](/0.9.0/getting-started/concepts/): tiling strategies, memory pools, execute-in-place
* [CLI Reference](/0.9.0/toolchain/compile/): supported commands and flags
* [Runtime Integration](/0.9.0/runtime/integration/): full C API and firmware integration

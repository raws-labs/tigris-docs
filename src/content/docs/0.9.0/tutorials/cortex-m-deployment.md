...
description: Run a TiGrIS-compiled INT8 model on an Arm Cortex-M board with
  CMSIS-NN, from ONNX to on-device inference.
sidebar:
  order: 100
slug: 0.9.0/tutorials/cortex-m-deployment
---
...
budget until the plan fits. See the [`compile`](/0.9.0/toolchain/compile/)
reference for the full flag set and [Operator and Backend
Support](/0.9.0/runtime/operator-support/) for what the
...
[`codegen`](/0.9.0/toolchain/codegen/) for the other formats
and backends.
...
* [`compile`](/0.9.0/toolchain/compile/) and
  [`codegen`](/0.9.0/toolchain/codegen/): the full CLI
  reference.

...
description: Read the analyze report, find the stage that sets the floor on
  SRAM, and work through the levers that actually move it.
sidebar:
  order: 150
slug: 0.9.0/guides/model-does-not-fit
---
...
For the report's fields, see [`analyze`](/0.9.0/toolchain/analyze/). For how the
compiler arrives at those numbers, see
[Tiling](/0.9.0/architecture/tiling/).
